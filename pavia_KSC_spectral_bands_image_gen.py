...
PAVIA_test_img = np.zeros(shape=(610, 340))
for i in range(610):
    for j in range(340):
        # i, j indexes for spatial dimensions, spectral channel 100th
        PAVIA_test_img[i][j] = data_pavia['paviaU'][i][j][100]

# imsave('true_color_img.png', true_color_img)
# scipy.misc.imsave is deprecated
imageio.imsave(dir_path + '/Generated_Images/PAVIA_test_img.png', PAVIA_test_img)
